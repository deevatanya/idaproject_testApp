<template>
  <div class="item_basket">
    <div class="item_basket_photo">
      <img :src="`https://frontend-test.idaproject.com${this.$props.basketProduct.photo}`" alt="louis vuitton" />
    </div>
    <div class="item_basket_info">
      <div class="item_basket_title">
        {{ this.$props.basketProduct.name }}
      </div>
      <div class="item_basket_price">{{ this.$props.basketProduct.price }} ₽</div>
      <div class="item_basket_star">
        <img src="/item_star.svg" alt="star" />
        <div class="item_basket_star_rating">{{ this.$props.basketProduct.rating }}</div>
      </div>
    </div>
    <div class="item_basket_delete" @click="deleteProduct()">
...
export default {
  ...
  methods: {
    deleteProduct() {
      this.$store.commit('deleteBasketProducts', this.$props.basketProduct);
    },
  }
}
</script>
