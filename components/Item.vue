<template>
  <div class="item" :data-category="this.$props.product.category">
    <div class="item_icons">
    <div class="item_icons_star">
      <img src="/item_star.svg" alt="star" />
      <div class="item_icons_star_rating">{{ this.$props.product.rating }}</div>
    </div>
    <div class="item_icons_cart" @click="addInBasket()">
    ...
    <div class="item_photo">
      <img :src="`https://frontend-test.idaproject.com${this.$props.product.photo}`" alt="louis vuitton" />
    </div>
    <div class="item_title">
      {{ this.$props.product.name }}
    </div>
    <div class="item_price">{{ this.$props.product.price }} ₽</div>
  </div>
</template>
...
export default {
  ...
  methods: {
    addInBasket() {
      if (!this.$store.state.basketProducts.hasOwnProperty(this.$props.product.id)) {
        this.$store.commit('addBasketProducts', this.$props.product);
      } else {
